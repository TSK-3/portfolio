          ...
          <ul className='nav_buttons'>
            ...
            <li>
              <button className="github-btn" aria-label="GitHub">
                <svg className="github-icon" height="28" width="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="www.github.com/TSK-3"></a>
              </button>
            </li>
            <li><button><a href="www.github.com/TSK-3">Contact</a></button></li>
          </ul>
        </nav>
      </div>
    </>
